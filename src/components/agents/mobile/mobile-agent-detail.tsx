    ...
    mutationFn: () =>
      upsertAgent({
        data: {
          ...
          top_p: form.top_p !== undefined && form.top_p !== null ? Number(form.top_p) : null,
          max_tokens: form.max_tokens ? Number(form.max_tokens) : null,
          frequency_penalty: form.frequency_penalty !== undefined && form.frequency_penalty !== null ? Number(form.frequency_penalty) : null,
          presence_penalty: form.presence_penalty !== undefined && form.presence_penalty !== null ? Number(form.presence_penalty) : null,
        },
      }),
    onSuccess: (row) => {
