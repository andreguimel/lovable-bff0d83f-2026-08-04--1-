...
export function FlowCanvasV2({ className }: FlowCanvasV2Props) {
  ...
  const nodes = useMemo<Node[]>(() => {
    ...
    return nodeIds
      ...
      .map<Node>((n) => ({
        id: n.id,
        type: (n.kind === "message" || n.kind === "action" || n.kind === "start" || n.kind === "menu" || n.kind === "condition" || n.kind === "subflow" || n.kind === "flow_connection" || n.kind.startsWith("container_")) ? "container_block" : (isV3Kind(n.kind) ? "fbv3" : "fbv2"),
        position: n.position,
