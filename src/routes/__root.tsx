...
import { GuardianIncidentListener } from "@/components/guardian/incident-toast";
// OfflineBanner removed — was overlapping mobile bottom-nav and disruptive on flaky networks.
import { reportBoundaryError } from "@/lib/guardian-reporter";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zenda — Automação de WhatsApp com IA" },
      {
        name: "description",
        content:
          "CRM omnichannel com múltiplos WhatsApps, agentes de IA, fluxos visuais, campanhas e inbox unificada.",
      },
      { name: "author", content: "Zenda" },
      { property: "og:title", content: "Zenda — Automação de WhatsApp com IA" },
      {
